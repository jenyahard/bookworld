...
### A Блог для авторов книг, где пользователи могу делиться своими книгами, смотреть продукты коллег и обмениваться комментариями.
### A BOOKWORLD написан на Django
